  ...
  return (
    <main className="page-shell admin-page-shell">
      <section className="admin-stack">
        <ShellCard eyebrow="Booking" title="Resources">
          <p>Manage tables, rooms, clinicians, or other resources that can receive bookings.</p>
        </ShellCard>
        ...
        <div className="admin-table" role="table" aria-label="Resources">
