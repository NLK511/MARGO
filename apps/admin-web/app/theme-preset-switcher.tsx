...
export function ThemePresetSwitcher({
  ...
  const [form, setForm] = useState<BrandingFormState>(() => ({
    ...
    nav: stringRecordValue(initialLayoutConfig, 'nav', 'top'),
    navSticky: booleanRecordValue(initialLayoutConfig, 'navSticky', true),
    ...
    hero: stringRecordValue(initialLayoutConfig, 'hero', 'split-image'),
    contentWidth: normalizeSideMarginsSelection(stringRecordValue(initialLayoutConfig, 'contentWidth', getThemePreset(initialPresetId).layout.contentWidth)),
    sectionRhythm: stringRecordValue(initialLayoutConfig, 'sectionRhythm', 'spacious'),
    sectionBorder: stringRecordValue(initialLayoutConfig, 'sectionDivider', stringRecordValue(initialLayoutConfig, 'sectionBorder', 'thin')),
